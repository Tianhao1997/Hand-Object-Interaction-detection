...
class imdb(object):
    ...
    def __init__(self, name, classes=None):
        """
        :param name: string, 'VOC_2007_trainval'
        :param classes:
        """
        self._name = name
        self._num_classes = 0
    ...
    def append_flipped_images(self, leftright=False):
        ...
        for i in range(num_images):
            ...
            oldx1 = boxes[:, 0].copy()
            oldx2 = boxes[:, 2].copy()
            print('image_index', self.image_path_at(i))
            print(oldx1, oldx2)
            ...
            gt_index = self.roidb[i]['gt_classes']
            if leftright:
                if self.roidb[i] == 2:
                    print("change index")
                    gt_index = 3
